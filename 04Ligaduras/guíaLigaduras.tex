...
\item 
	...
	\begin{enumerate}
		...
		\(
			% notación intuitiva
			\frac{R_{aro} \left(- 2 R_{aro} m \ddot{\theta} - 2 R_{aro} m_{aro} \ddot{\theta} - 2 R_{aro} m_{pesa} \ddot{\theta} - R_{aro} m_{polea} \ddot{\theta} + 2 g m \cos{\left(\theta \right)} - 2 g m_{pesa}\right)}{2} = 0
			% R_{aro}^{2} m \ddot{\theta} + R_{aro}^{2} m_{aro} \ddot{\theta} + \frac{R_{aro}^{2} m_{polea} \ddot{\theta}}{2} - R_{aro} g m \cos{\left(\theta \right)} + R_{polea}^{2} m_{pesa} \ddot{\theta} + R_{polea} g m_{pesa} = 0
			% notación geométrica
