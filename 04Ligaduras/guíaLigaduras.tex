...
\item 
	\begin{minipage}[t][11cm]{0.7\textwidth}
		...
		\begin{enumerate}
			...
			Así que basta con usar la única función de vínculo hallada en el punto anterior para obtener la ecuación de Euler-Lagrange en función \(y_1\).
			\item Lo que plantea el punto anterior rara vez sucede.
			Lo usual es que la cuerda no deslice y gire solidaria con la cuerda.
			...
			Modele este nuevo vínculo como  función de \(theta\) y una de las coordenadas \(y_i\).
			...
			Modelando la polea como un cilindro homogéneo, su momento de inercia ante rotaciones en torno a su eje de simetría longitudinal es \((m/2) R^2\).
		\end{enumerate}
	\end{minipage}
	...
	\begin{minipage}[t][10cm]{0.67\textwidth}
		...
		\begin{enumerate}
			...
			\item Resuelva este sistema de ecuaciones para obtener las dos correspondientes aceleraciones generalizadas.\\
			Resultados:\\
			\(
			...
			\)
			\item Calcule las aceleraciones de las tres pesas.\\
			Resultados:\\
			\(
