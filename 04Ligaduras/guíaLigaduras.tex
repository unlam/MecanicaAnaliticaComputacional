...
\item 
	...
	\end{minipage}
		\begin{enumerate}
			...
			Calcule la ecuación de Euler-Lagrange para \(y_1\) usando el vínculo del punto anterior.
			\item Lo usual es que la cuerda no deslice y gire solidaria a la polea.
			Esto vincula \(\theta\) al desplazamiento de la cuerda, medido con alguna de las coordenadas \(y_i\).
			Escriba esta función de vínculo.
			\item La energía cinética de rotación es función del momento de inercia y la velocidad angular, que con este último vínculo puede expresarse en función de \(\dot{y}_1\). 
			Calcule la ecuación de Euler-Lagrange para \(y_1\) modelando la polea como un cilindro homogéneo, por lo que su momento de inercia en torno a su eje de simetría longitudinal es \((m/2) R^2\).
		\end{enumerate}
