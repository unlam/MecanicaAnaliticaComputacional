...
\begin{enumerate}
	...
	\begin{minipage}[c][5cm][t]{0.3\textwidth}
		\includegraphics[width=\textwidth]{hibb_21-45_axis}
	\end{minipage}
		Resultado: \(
	...
	\begin{enumerate}
		\item Rotar en \(\theta\) el tensor de inercia de la barra en su centro de masa hasta el sistema de ejes azul.
		\item Sume el tensor de Steiner para obtener tal tensor calculado desde el origen del sistema rojo.
		\item Ese desplazamiento entre los origenes de ambos sistemas es el mismo que debe consirerarse para el torque que produce el peso de la barra.
	\end{enumerate}
