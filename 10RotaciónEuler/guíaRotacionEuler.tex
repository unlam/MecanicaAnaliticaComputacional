...
\begin{enumerate}
	...
	\begin{minipage}[t][5.5cm]{0.65\textwidth}
		...
		\textbf{Ayuda:} No olvide que se aplica una aceleración centrípeta sobre G, \(\vec{a}_{c} = \dfrac{|\alpha_c|}{d_{AG}} \hat{x}\), al expresar las ecuaciones de la segunda ley de Newton.
	\end{minipage}
