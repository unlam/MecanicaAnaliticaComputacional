...
\begin{enumerate}
	...
	\begin{minipage}[t][6cm]{0.65\textwidth}
		...
		Un cilindro de 15 lb gira alrededor del eje AB con una velocidad angular \(\vec{\omega} = -\SI{4}{\per\second} \hat{x}\).
		...
		Esta surge, porque al girar junto con el cilindro, el sistema de referencia se torna en un \textbf{sistema no inercial}, en el que se percibe una \textbf{fuerza ficticia centrífuga} dada por \(- m \dfrac{|\alpha_c|}{d_{AG}} \hat{x}\).
	\end{minipage}
