...
\begin{enumerate}
	...
	\begin{minipage}[t][5.5cm]{0.65\textwidth}
		...
		El sistema de coordenadas tiene origen en \(G\), centro de masa del cilindro.

		\textbf{Ayuda:} No olvide que en G se percibe una aceleración ``centrífuga'', \(\vec{a}_{c} = \dfrac{|\alpha_c|}{d_{AG}} \hat{x}\), al expresar las ecuaciones de la segunda ley de Newton. Será cuestión del cojinete en B en proveer de una reacción en \(\hat{x}\) para ejercer la fuerza centrípeta que mantenga el cilindro en su trayectoria circular.
	\end{minipage}
