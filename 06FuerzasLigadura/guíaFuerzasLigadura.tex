...
\begin{enumerate}
	...
	\begin{minipage}[t][4.5cm]{0.62\textwidth}
		...
		Para obtener \(\theta_\mathrm{despegue}\) hay que tener presente que:
		\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Iguale (ecuación) la energía mecánica inicial con la de despegue. Para esto tendrá que substituir en su expresión una vez para las condiciones iniciales (cuando estaba arriba) y otra vez para el momento del despegue.
