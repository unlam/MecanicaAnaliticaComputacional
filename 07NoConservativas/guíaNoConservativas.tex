...
\end{minipage}
Justifique su repuesta a esta pregunta conceptual:
...
\(
	\ddot{\theta} = \dfrac{- K_{T} \theta + \tau}{L^{2} m \left(\cos^{2}{\left(\phi \right)} + 1\right)}
...
\end{minipage}
Justifique su repuesta a esta pregunta conceptual: ¿Qué es la fuerza generalizada asociada al desplazamiento virtual $\delta x$ debida a $\vec{F}$?
