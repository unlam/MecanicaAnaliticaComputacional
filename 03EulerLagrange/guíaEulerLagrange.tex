...
\item
	...
	\begin{minipage}[c][0cm][t]{0.3\textwidth}
		\input{figs/mobileSlide.tikz}
		% \includegraphics[width=0.75\textwidth]{cmchap6_fig6_8.png}
	\end{minipage}
	Puede notarse que como se obtuvo un sistema de dos ecuaciones diferenciales ligadas, ésto no permite responder a un interrogante como: ``De soltar el bloque más pequeño, ¿qué aceleración tiene el plano?''.
	En la siguiente guía de ejercicios se utilizará SymPy pare resolver tales sistemas.
...
\item
	...
	\end{minipage}
	\begin{minipage}[c][0cm][t]{0.3\textwidth}
		\input{figs/mobilePendulum.tikz}
