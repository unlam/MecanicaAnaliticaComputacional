...
\item
	\begin{minipage}[t][7.1cm]{0.55\textwidth}
		...
		El punto de suspensión engarzado en un aro de radio \(a\) dispuesto verticalmente rota respecta a su centro con una frecuencia \(\omega\) \emph{constante}.
...
\item
	\begin{minipage}[t][7cm]{0.65\textwidth}
		...
		La pieza con \(m_2\) se desplaza sobre un eje vertical, y todo el sistema gira con una velocidad angular \(\Omega\) \emph{constante} en torno a ese eje.
	...
	Todo gira en torno al eje rosa con velocidad angular $\Omega$ \emph{constante}.
